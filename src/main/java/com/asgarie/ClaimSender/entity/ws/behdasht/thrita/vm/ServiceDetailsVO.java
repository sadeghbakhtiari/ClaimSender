 ...
 *       &lt;sequence>
 *         &lt;element name="ExtraLocation" type="{http://thrita.behdasht.gov.ir/VM/}OrganizationVO" minOccurs="0"/>
 *         &lt;element name="RelatedService" type="{http://thrita.behdasht.gov.ir/VM/}ArrayOfServiceDetailsVO" minOccurs="0"/>
 *         &lt;element name="PKID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="RelativeCost" type="{http://thrita.behdasht.gov.ir/VM/}ArrayOfRelativeCostVO" minOccurs="0"/>
 ...
 *         &lt;element name="Service" type="{http://thrita.behdasht.gov.ir/VM/}DO_CODED_TEXT" minOccurs="0"/>
 *         &lt;element name="StartDate" type="{http://thrita.behdasht.gov.ir/VM/}DO_DATE" minOccurs="0"/>
 *         &lt;element name="StartTime" type="{http://thrita.behdasht.gov.ir/VM/}DO_TIME" minOccurs="0"/>
 *         &lt;element name="EndDate" type="{http://thrita.behdasht.gov.ir/VM/}DO_DATE" minOccurs="0"/>
 *         &lt;element name="EndTime" type="{http://thrita.behdasht.gov.ir/VM/}DO_TIME" minOccurs="0"/>
 ...
 *         &lt;element name="WardType" type="{http://thrita.behdasht.gov.ir/VM/}DO_CODED_TEXT" minOccurs="0"/>
 *         &lt;element name="WardName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="ServiceProvider" type="{http://thrita.behdasht.gov.ir/VM/}HealthcareProviderVO" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ServiceDetailsVO {
    ...
    @XmlElement(name = "ExtraLocation")
    protected OrganizationVO extraLocation;
    @XmlElement(name = "RelatedService")
    protected ArrayOfServiceDetailsVO relatedService;
    ...
    /**
     * Gets the value of the extraLocation property.
     * 
     * @return
     *     possible object is
     *     {@link OrganizationVO }
     *     
     */
    public OrganizationVO getExtraLocation() {
        return extraLocation;
    }

    /**
     * Sets the value of the extraLocation property.
     * 
     * @param value
     *     allowed object is
     *     {@link OrganizationVO }
     *     
     */
    public void setExtraLocation(OrganizationVO value) {
        this.extraLocation = value;
    }
     ...
     *     
     */
    public ArrayOfServiceDetailsVO getRelatedService() {
     ...
     *     
     */
    public void setRelatedService(ArrayOfServiceDetailsVO value) {
